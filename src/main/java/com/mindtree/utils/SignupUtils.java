...
public class SignupUtils {
	...
	public OTP sendMail(String email, String check) throws MessagingException {
	      ...
	      if(check.equals("forgot")) {
	    	  ...
	    	  msg = "Did you just make a request to reset your password? \r\n"
	  				+ "Yes? Go right ahead.Please enter the following otp to change your password.";
	      }
	      else {
	    	  sub = "Welcome to OrderMyFood";
	    	  msg = "Please enter the following otp to activate your account.";
	      }
